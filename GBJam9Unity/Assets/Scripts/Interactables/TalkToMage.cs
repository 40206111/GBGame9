...
public class TalkToMage : MonoBehaviour, IInteractable
{
     ...
     void ConversationWithCauldron()
    {
        if (!Visited)
        {
            ...
            DialogueBoxControl.Instance.QueueDialogue("A strange chicken walks into my house uninvited and I'm supposed to be the one that knows what's going on?", eSpeakingCharacter.Mage, leftSide: true, closeAfterText: true);
            ...
            DialogueBoxControl.Instance.QueueDialogue("... Yes... But aside from that... Can you... help me work out what's going on?", eSpeakingCharacter.Melee, leftSide: false, closeAfterText: true);
            Visited = true;
        }
